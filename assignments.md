...
**Due date:** Tuesday, 24 Mehr, 23:59
...
* On the database of your choice, practice different data visualization techniques
    ...
    * You can use the [lab sessions's notebook](https://colab.research.google.com/drive/16JzoMVeLRc2B3N5R_OeZFRZ8HFvfr487?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1MnDoavy9aqPrODvCClsHUQPiU-ZDp9iu?usp=sharing) as a guideline.


Please hand in the *compiled* notebook (or the link to your *compiled* notebook on Google Colab/Github/Kaggle) **on the assignment page of Microsoft Teams**.

**Due date:** Tuesday, Aban 8, 23:59
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1rjhtmtbN7wNm6jzYVhAU34ryK41uKlQy?usp=sharing) as a guideline.
...
**Due date:** Tuesday 15 Aban, 23:59
...
**Due date:** Tuesday, Aban 22, 23:59
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1wLQcjpjxNYXl5WDI45MyNOZDTw1POl8i?usp=sharing) as a guideline.
...
* All scores are measured on test set, which should be 20% of the whole dataset
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1G7yUYsXamL4fewOb5dKydf7-Ke2LSoXy?usp=sharing) as a guideline.
...
* All scores are measured on test set, which should be 20% of the whole dataset
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/18JvMK-xbITCegO53Y3yGSwWD9VqVgFIA?usp=sharing) as a guideline.
...
* All scores are measured on test set, which should be 20% of the whole dataset
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1UlD57pH_dcmoeR0_ai1avo7_RxTbg3OF?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1FiLzy5tmf3wU8gryJ_i_gpq3CqmR6qlh?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1qovIbzAxUDvVNQ6qvpnlqsCfmZrIfHom?usp=sharing) as a guideline.
